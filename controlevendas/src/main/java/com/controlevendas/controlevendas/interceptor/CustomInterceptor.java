package com.controlevendas.controlevendas.interceptor;
...
public class CustomInterceptor extends HandlerInterceptorAdapter {
	...
	public void postHandle(HttpServletRequest req, HttpServletResponse res, Object handler, ModelAndView modelAndView)
		...
		log.info("Response: " + res.getStatus() + " - " + (end - start) + "ms - " + req.getRequestURL() + " - "
				+ this.usuario.getNmEmail());
	}
	...
	private String validateUsuario(HttpServletRequest req, Object handler, Long userId, String reqIp) {
		...
		log.info("Request: " + req.getMethod() + " - " + req.getRequestURL() + " - " + this.usuario.getNmEmail());
		return "";
	}
